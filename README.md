...
To host our NodeJS backend we will be using Heroku. Heroku is a cloud platform that ties easiy into Git and works well with NodeJS. You will need a Heroku account to be able to push code to it. You can sign up by going to [Heroku's website](www.heroku.com).
